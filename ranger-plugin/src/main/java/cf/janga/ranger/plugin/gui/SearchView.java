...
import cf.janga.ranger.plugin.actions.ChangeSearchDepthAction;
import cf.janga.ranger.plugin.actions.CollapseAllAction;
import cf.janga.ranger.plugin.actions.DefaultGroupingAction;
import cf.janga.ranger.plugin.actions.ExpandAllAction;
import cf.janga.ranger.plugin.actions.GroupByClassAction;
import cf.janga.ranger.plugin.actions.GroupByProjectAction;
import cf.janga.ranger.plugin.actions.OpenInEditorAction;
import cf.janga.ranger.plugin.actions.StopSearchAction;
